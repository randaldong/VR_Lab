...
public class xposi : MonoBehaviour, myInteractable
{
    ...
    bool myInteractable.Leftinteract(MyInteractor interactor)
    {
        ...
        Quaternion rotationIncrement = Quaternion.AngleAxis(movingStep *3f, Vector3.forward);
    ...
    bool myInteractable.Rightinteract(MyInteractor interactor)
    {
        ...
        refObj.transform.position = refObj.transform.position + new Vector3(movingStep, 0f, 0f);
        return true;
    }
